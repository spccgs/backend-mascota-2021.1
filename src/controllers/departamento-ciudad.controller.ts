...
export class DepartamentoCiudadController {
  ...
  async find(
    ...
    return this.departamentoRepository.cidades(id).find(filter);
  }
  ...
  async create(
    ...
    return this.departamentoRepository.cidades(id).create(ciudad);
  }
  ...
  async patch(
    ...
    return this.departamentoRepository.cidades(id).patch(ciudad, where);
  }
  ...
  async delete(
    ...
    return this.departamentoRepository.cidades(id).delete(where);
  }
}
